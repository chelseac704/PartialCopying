...
class Population:
    ...
    def set_community(self,in_group,out_group):
        ...
        graph = nx.stochastic_block_model(sizes=[25,25,25,25],
                          p=[[in_group, out_group, out_group, out_group],
    ...
    def get_neighbors(self, ind):
        neighbors = [i for i in range(len(self.adj_matrix[ind])) if self.adj_matrix[ind][i]==1]
        return neighbors
